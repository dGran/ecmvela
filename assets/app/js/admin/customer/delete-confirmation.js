...
function deleteConfirmation(form, name)
{
    Swal.fire({
        ...
        customClass: {
            ...
            cancelButton: 'px-6 py-2.5 mr-3 bg-transparent font-medium text-xs leading-tight uppercase text-slate-400 hover:text-slate-700 focus:text-slate-700 focus:outline-none focus:ring-0 transition duration-150 ease-in-out',
